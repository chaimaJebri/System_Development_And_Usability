	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(course != null)
		{
			...
			else
			{
				...
				{
					request.setAttribute("noModules", "Oups! No modules have been added yet");
				}
				
				courseQuizzes=quizDao.getQuizzesByCourseID(courseID);
				if (courseQuizzes.isEmpty())
				{
					request.setAttribute("noQuizzes", "Oups! No quizzes have been added yet");
				}
			}			
		...
		{
			request.setAttribute("courseNotFound", "Oups! Course with ID: '"+courseID+"', Not Found");
		}
