...
<head>
	...
	<title>Edit Terms & Policies</title>
...
<body>
	...
	<h1>System's Terms And Policies</h1>
	...
	<div class="formContainer">
		<form method="post" action="./TermsAndPoliciesHandler">
			...
			<span id="validateEditedTermsPolicies" class="formComponent"></span>
			
			<button type="submit" id="editTermsPoliciesBtn" class="formComponent btn btn-success">Save Changes</button>
