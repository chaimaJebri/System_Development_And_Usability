...
<body>
	...
	<div class="navbarContainer">
		<form action="./registrationForm.jsp" method="get" class="navbarComponent">
			<button type="submit" title="Back to sign up page"  class="btn btn-dark"><i class="bi bi-arrow-left-circle"></i> Back to Sign Up</button>
		</form>
	</div>
